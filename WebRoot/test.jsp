...
<!-- 4g图传实时视频 -->
<link rel="stylesheet" type="text/css" href="<%=path%>/css/vedio.css" />
	...
	<div id="header">
		...
		<div id="query">
			<form action="<%=path%>/CarAction!lonlatlist?start=&stop=" method="get">
				<span id="track-panel" style="color: #333;" ><a href="<%=path%>/MainUI.html" path="<%=path%>">视频监控</a></span> | &nbsp;&nbsp;
				...
				开始时间 &nbsp;&nbsp;<input type="text" id="start" name="start" style="width:150px; margin-right:10px;color: #333;" id="qwe" readonly onClick="WdatePicker({isShowClear:false,maxDate:'%y-%M-%d 23:59:59',dateFmt:'yyyy-MM-dd HH:00:00'});" />
				结束时间&nbsp;&nbsp;<input type="text" id="end" name="end" style="width:150px; margin-right:10px;color: #333;"  id="qwe" readonly onClick="WdatePicker({isShowClear:false,maxDate:'%y-%M-%d 23:59:59',dateFmt:'yyyy-MM-dd HH:00:00'});"  />
				<input type="button" id="guijiQuery" value="轨迹查询" style="color: #333;" onclick="queryHistoryTrackByCarId()" />
...
<script type="text/javascript">
    ...
    CKobject.embed('<%=path%>/script/ckplayer.swf','player1','ckplayer_a1','600','400',false,flashvars,video);
</script>
